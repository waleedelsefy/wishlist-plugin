...
list ( $field_id, $name, $class, $placeholder, $std, $value, $data, $custom_attributes ) = aj_plugin_fw_extract( $field, 'id', 'name', 'class', 'placeholder', 'std', 'value', 'data', 'custom_attributes' );
