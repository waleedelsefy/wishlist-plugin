...
list ( $field_id, $class, $name, $value, $std, $buttons, $custom_attributes, $data ) = aj_plugin_fw_extract( $field, 'id', 'class', 'name', 'value', 'std', 'buttons', 'custom_attributes', 'data' );
...
<input type="text"
	...
	<?php echo ! $backward_compatibility && isset( $data ) ? aj_plugin_fw_html_data_to_string( $data ) : ''; ?>
/>
<?php
if ( isset( $buttons ) ) {
	$button_field = array(
	...
	aj_plugin_fw_get_field( $button_field, true );
}
?>
