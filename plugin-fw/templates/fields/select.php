...
list ( $field_id, $class, $name, $value, $options, $multiple, $placeholder, $buttons, $custom_attributes, $data ) = aj_plugin_fw_extract( $field, 'id', 'class', 'name', 'value', 'options', 'multiple', 'placeholder', 'buttons', 'custom_attributes', 'data' );
