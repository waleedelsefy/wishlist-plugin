...
list ( $field_id, $name, $class, $std, $value, $data, $custom_attributes, $desc_inline ) = aj_plugin_fw_extract( $field, 'id', 'name', 'class', 'std', 'value', 'data', 'custom_attributes', 'desc-inline' );
?>
