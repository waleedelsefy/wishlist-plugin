...
list ( $field_id, $class, $name, $value,
	 ...
	 */
	$option,
	$min, $max, $step, $custom_attributes, $data ) = aj_plugin_fw_extract( $field, 'id', 'class', 'name', 'value', 'option', 'min', 'max', 'step', 'custom_attributes', 'data' );
...
?>
<div class="aj-plugin-fw-slider-container <?php echo ! empty( $class ) ? esc_attr( $class ) : ''; ?>">
	<div class="ui-slider">
