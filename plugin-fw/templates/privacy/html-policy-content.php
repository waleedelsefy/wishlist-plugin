...
<div class="wp-suggested-text">
	<?php do_action( 'aj_plugin_fw_privacy_guide_content_before' ); ?>

	<?php
	foreach ( $sections as $key => $section ) {
		$privacy_action = "aj_plugin_fw_privacy_guide_content_{$key}";
		$content        = apply_filters( 'aj_plugin_fw_privacy_guide_content', '', $key );
	...
	<?php do_action( 'aj_plugin_fw_privacy_guide_content_after' ); ?>
</div>
