...
$container_classes = array(
	'dido_options',
	'aj-plugin-fw-field-wrapper',
	"aj-plugin-fw-{$field_type}-field-wrapper",
);
$container_classes = implode( ' ', $container_classes );
?>
<div id="<?php echo esc_attr( $container_id ); ?>" class="<?php echo esc_attr( $container_classes ); ?>" <?php echo aj_panel_field_deps_data( $option, $this ); ?>>
	<div class="option">
		<?php aj_plugin_fw_get_field( $field, true, false ); ?>
	</div>
