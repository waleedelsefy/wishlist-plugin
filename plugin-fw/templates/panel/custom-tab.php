...
$tab_id         = sanitize_key( implode( '-', array_filter( array( 'aj-plugin-fw-panel-custom-tab', $current_tab, $current_sub_tab ) ) ) );
?>
<?php if ( $show_container ) : ?>
	<div id='<?php echo esc_attr( $tab_id ); ?>' class='aj-plugin-fw-panel-custom-tab-container'>
	<?php if ( $is_sub_tab ) : ?>
		<div class='aj-plugin-fw-panel-custom-sub-tab-container'>
	<?php endif; ?>
<?php endif; ?>

<?php if ( $the_title ) : ?>
	<h2 class="aj-plugin-fw-panel-custom-tab-title"><?php echo wp_kses_post( $the_title ); ?></h2>
<?php endif; ?>
...
<?php if ( $show_container ) : ?>
	<?php if ( $is_sub_tab ) : ?>
		</div><!-- /.aj-plugin-fw-panel-custom-sub-tab-container -->
	<?php endif; ?>
	</div><!-- /.aj-plugin-fw-panel-custom-tab-container -->
