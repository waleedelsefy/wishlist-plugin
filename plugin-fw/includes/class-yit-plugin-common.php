<?php
/**
 * AJ Plugin Common Class.
 *
 * @class   DIDO_Plugin_Common
 * @package AJ\PluginFramework\Classes
 */

defined( 'ABSPATH' ) || exit; // Exit if accessed directly.

if ( ! class_exists( 'DIDO_Plugin_Common' ) ) {
	/**
	 * DIDO_Plugin_Common class.
	 *
	 * @deprecated 3.5
	 */
	class DIDO_Plugin_Common {
		...
		public function init() {
			self::$config['header_backgrounds'] = apply_filters( 'dido_header_backgrounds', self::$config['header_backgrounds'] );
			self::$config['body_backgrounds']   = apply_filters( 'dido_body_backgrounds', self::$config['body_backgrounds'] );
		}
		...
		public static function get_icon_list() {
			...
			return apply_filters( 'dido_icon_list', $standard_icon_list );
		}
