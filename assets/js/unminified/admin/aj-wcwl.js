/**
 * Admin AJ WooCommerce Wishlist JS
 *
 * @author AJ
...
jQuery( function( $ ) {
    ...
    $.fn.dependency = function (deps, test, complete, args) {
        ...
        t.on('change', function () {
            ...
            $.each(deps, function (i, v) {
                ...
                // val ? target.removeClass('aj-disabled') : target.addClass('aj-disabled');
            });
    ...
    var Wizard = function( el, args ){
            ...
            self._init = function(){
                self.settings = $.extend( {
                    ...
                    template_data: {},
                    container: '.aj-wcwl-wizard-modal',
                    events: {}
                }, args );
        ...
        getPromotionWizardData = function(){
            return {
                template: 'aj-wcwl-promotion-wizard',
    ...
    var disable_wishlist_for_unauthenticated_users = $('#aj_wcwl_disable_wishlist_for_unauthenticated_users'),
        multi_wishlist_enable = $('#aj_wcwl_multi_wishlist_enable'),
        enable_multi_wishlist_for_unauthenticated_users = $('#aj_wcwl_enable_multi_wishlist_for_unauthenticated_users'),
        modal_enable = $('#aj_wcwl_modal_enable'),
        loop_position = $('#aj_wcwl_loop_position'),
        icon_select = $('.icon-select'),
        add_to_cart_style = $('[name="aj_wcwl_add_to_cart_style"]'),
        add_to_cart_icon = $('#aj_wcwl_add_to_cart_icon'),
        ask_an_estimate_style = $('[name="aj_wcwl_ask_an_estimate_style"]'),
        ask_an_estimate_icon = $('#aj_wcwl_ask_an_estimate_icon'),
        enable_share = $('#aj_wcwl_enable_share'),
        share_facebook = $('#aj_wcwl_share_fb'),
        share_facebook_icon = $('#aj_wcwl_fb_button_icon'),
        share_twitter = $('#aj_wcwl_share_twitter'),
        share_twitter_icon = $('#aj_wcwl_tw_button_icon'),
        share_pinterest = $('#aj_wcwl_share_pinterest'),
        share_pinterest_icon = $('#aj_wcwl_pr_button_icon'),
        share_email = $('#aj_wcwl_share_email'),
        share_email_icon = $('#aj_wcwl_em_button_icon'),
        share_whatsapp = $('#aj_wcwl_share_whatsapp'),
        share_whatsapp_icon = $('#aj_wcwl_wa_button_icon'),
        show_estimate_button = $('#aj_wcwl_show_estimate_button'),
        show_additional_info_textarea = $('#aj_wcwl_show_additional_info_textarea'),
        ask_an_estimate_fields = $('#aj_wcwl_ask_an_estimate_fields'),
        promotion_mail_type = $('#woocommerce_promotion_mail_settings\\[email_type\\]'),
        back_in_stock_mail_enabled = $('#woocommerce_aj_wcwl_back_in_stock_settings\\[enabled\\]'),
        back_in_stock_mail_type = $('#woocommerce_aj_wcwl_back_in_stock_settings\\[email_type\\]'),
        on_sale_item_mail_enabled = $('#woocommerce_aj_wcwl_on_sale_item_settings\\[enabled\\]'),
        on_sale_item_mail_type = $('#woocommerce_aj_wcwl_on_sale_item_settings\\[email_type\\]'),
        ask_an_estimate_type = $('[id^="type_"]');

    loop_position.add('select#aj_wcwl_button_position').on('change', function () {
        var t = $(this),
            v = t.val();
    ...
    ask_an_estimate_type.on( 'change', function(){
        var t = $(this),
            v = t.val(),
            options_field = t.closest( '.aj-toggle-content-row' ).next();
    ...
    disable_wishlist_for_unauthenticated_users.dependency([
        '#aj_wcwl_enable_multi_wishlist_for_unauthenticated_users-yes'
    ], function(){
    ...
    enable_multi_wishlist_for_unauthenticated_users.dependency([
        '#aj_wcwl_show_login_notice',
        '#aj_wcwl_login_anchor_text'
    ], function(){
    ...
    modal_enable.dependency([
        '#aj_wcwl_show_exists_in_a_wishlist'
    ], function(){
        var res = modal_enable.find( ':checked' ).val() !== 'default';

        if( ! res ){
            $('#aj_wcwl_show_exists_in_a_wishlist').prop( 'checked', true );
        }
    ...
    share_facebook.dependency([
        '#aj_wcwl_fb_button_icon',
        '#aj_wcwl_color_fb_button_background'
    ], function(){
    ...
    share_twitter_icon.dependency([
        '#aj_wcwl_tw_button_custom_icon'
    ], function(){
        return isChecked( share_twitter ) && isChecked( enable_share ) && 'custom' === share_twitter_icon.val();
    } );

    share_pinterest.dependency([
        '#aj_wcwl_socials_image_url',
        '#aj_wcwl_pr_button_icon',
        '#aj_wcwl_color_pr_button_background'
    ], function(){
    ...
    share_email_icon.dependency([
        '#aj_wcwl_em_button_custom_icon'
    ], function(){
        return isChecked( share_email ) && isChecked( enable_share ) && 'custom' === share_email_icon.val();
    } );

    share_whatsapp.dependency([
        '#aj_wcwl_wa_button_icon',
        '#aj_wcwl_wa_button_custom_icon',
        '#aj_wcwl_color_wa_button_background'
    ], function(){
    ...
    show_additional_info_textarea.dependency([
        '#aj_wcwl_additional_info_textarea_label'
    ], function(){
    ...
    show_additional_info_textarea.on( 'change', function(){
        ...
        if( t.is(':checked') && show_estimate_button.is(':checked') ){
            ask_an_estimate_fields.removeClass( 'aj-disabled' );
        }
        else {
            ask_an_estimate_fields.addClass( 'aj-disabled' );
        }
    } );
    ...
    back_in_stock_mail_enabled.dependency([
        '#woocommerce_aj_wcwl_back_in_stock_settings\\[product_exclusions\\]',
        '#woocommerce_aj_wcwl_back_in_stock_settings\\[category_exclusions\\]',
        '#woocommerce_aj_wcwl_back_in_stock_settings\\[email_type\\]',
        '#woocommerce_aj_wcwl_back_in_stock_settings\\[heading\\]',
        '#woocommerce_aj_wcwl_back_in_stock_settings\\[subject\\]',
        '#woocommerce_aj_wcwl_back_in_stock_settings\\[content_html\\]',
        '#woocommerce_aj_wcwl_back_in_stock_settings\\[content_text\\]'
    ], function(){
    ...
    on_sale_item_mail_enabled.dependency([
        '#woocommerce_aj_wcwl_on_sale_item_settings\\[product_exclusions\\]',
        '#woocommerce_aj_wcwl_on_sale_item_settings\\[category_exclusions\\]',
        '#woocommerce_aj_wcwl_on_sale_item_settings\\[email_type\\]',
        '#woocommerce_aj_wcwl_on_sale_item_settings\\[heading\\]',
        '#woocommerce_aj_wcwl_on_sale_item_settings\\[subject\\]',
        '#woocommerce_aj_wcwl_on_sale_item_settings\\[content_html\\]',
        '#woocommerce_aj_wcwl_on_sale_item_settings\\[content_text\\]'
    ], function(){
    ...
    $(document).on( 'aj-add-box-button-toggle', function(){
        var ask_an_estimate_type_new = $('#new_type'),
            ask_an_estimate_options_new = $('#new_options'),
            target = ask_an_estimate_options_new.closest('.aj-add-box-row');
