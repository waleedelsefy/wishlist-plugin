...
Contributors: ajemes
Tags: wishlist, woocommerce, products, themes, dido, e-commerce, shop
Requires at least: 5.3
Tested up to: 5.7
Stable tag: 3.0.20
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html
Documentation:https://dido.prdocs-plugins/aj-woocommerce-wishlist
...
* Dev: added aj_wcwl_mobile_media_query filter
* Dev: added new filters aj_wcwl_remove_after_add_to_cart and aj_wcwl_allow_remove_after_add_to_cart
...
* Dev: added fifth parameter for aj_wcwl_add_to_wishlist_button_html filter
* Dev: added new aj_wcwl_promotion_email_item filter
...
* Dev: added new filter aj_wcwl_dompdf_orientation
* Dev: added new filter aj_wcwl_additional_crons
...
* Dev: added aj_wcwl_reload_on_found_variation filter to allow dev programmatically disable ATW reload on found_variation
* Dev: added aj_wcwl_wishlist_view_images_after_thumbnail action
* Dev: added aj_wcwl_modern_wishlist_empty_message filter
* Dev: added aj_wcwl_ask_estimate_email_wishlist_name filter
...
* Dev: added new filter aj_wcwl_get_product_image_with_path
* Dev: added new filter aj_wcwl_set_session_cookie
* Dev: added new filter aj_wcwl_privacy_value
* Dev: added new filter aj_wcwl_wishlist_privacy_types
* Dev: added new filter aj_wcwl_available_admin_tabs_premium
* Dev: added new parameter to aj_wcwl_{privacy}_wishlist_visibility filter
...
* Fix: issue with cart redirect when using AJ WCCL
* Dev: added new aj_wcwl_admin_table_column_name_actions filter
* Dev: added new aj_wcwl_admin_table_column_username_row filter
...
* Dev: added new action aj_wcwl_before_add_all_to_cart_from_wishlist
* Dev: added new filter aj_wcwl_add_all_to_cart_from_wishlist
* Dev: added new filter aj_wcwl_add_all_to_cart_error_message
* Dev: added new filter aj_wcwl_add_wishlist_notice
* Dev: added new filter aj_wcwl_fragments_index_glue
...
* Fix: correctly applied aj_wcwl_is_wishlist_responsive filter to aj_wcwl_is_mobile function
...
* Dev: added aj_wcwl_ask_for_an_estimate_popup_text filter
* Dev: added aj_wcwl_show_wishlist_update_button filter
* Dev: added aj_wcwl_add_to_wishlist_icon_html filter
* Dev: added aj_wcwl_add_to_wishlist_heading_icon_html filter
* Dev: added aj_wcwl_add_to_wishlist_data trigger, to allow third party code change data submitted with ATW ajax call
...
* Dev: added aj_wcwl_create_wishlist_button_label filter
* Dev: added aj_wcwl_wishlist_download_url filter
* Dev: added aj_wcwl_is_wishlist_responsive filter, to allow developers disable responsive behaviour for the wishlist
* Dev: added aj_wcwl_generated_default_wishlist action
* Dev: added aj_wcwl_default_wishlist filter
* Dev: added aj_wcwl_add_notice wrapper function, to avoid possible fatal errors when calling wc_add_notice
...
* Fix: compatibility with AJ Infinite Scrolling when ajax loading is enabled
...
* Dev: added aj_wcwl_reload_fragments trigger to refresh wishlist fragments
* Dev: added aj_wcwl_remove_hidden_products_via_query filter
* Dev: added aj_wcwl_show_add_to_wishlist filter, to allow dev selectively hide Add to Wishlist buttons
* Dev: added aj_wcwl_create_wishlist_title_label filter
* Dev: added aj_wcwl_search_wishlist_title_label filter
* Dev: added aj_wcwl_manage_wishlist_title_label filter
...
* Tweak: using aj_wcwl_l10n.popup_timeout for wishlist messages too
...
* Fix: returning correct wishlist and user id to aj_wcwl_added_to_wishlist and aj_wcwl_removed_from_wishlist actions (thanks to danielbitzer)
* Fix: issue with default value for aj_wcwl_positions option
...
* Dev: added aj_wcwl_shortcode_share_link_url filter
* Dev: added aj_wcwl_popup_timeout filter
...
* Dev: added aj_wcwl_wishlist_view_images_columns filter
* Dev: added aj_wcwl_wishlist_delete_url filter
* Dev: added aj_wcwl_before_wishlist_create and aj_wcwl_after_wishlist_create inside create popup

= 3.0.3 - Released on 12 December 2019 =

* Tweak: prevent aj_setcookie to process if cookie name is not set
...
* Update: plugin framework
* Tweak: added defaults for aj_wcwl_add_to_cart_text option (thanks to ecksiteweb)
...
* Dev: new AJ_WCWL_Wishlist and AJ_WCWL_Wishlist_Item objects
* Dev: now using Data_store classes to handle db operations
* Dev: added filter aj_wcwl_loop_positions
* Dev: added filter aj_wcwl_custom_css_rules
* Dev: added filter aj_wcwl_session_cookie
* Dev: added filter aj_wcwl_item_formatted_price
* Dev: added filter aj_wcwl_wishlist_formatted_title
* Dev: added filter aj_wcwl_wishlist_get_items
* Dev: added filter aj_wcwl_user_cannot_add_to_wishlist_message
* Dev: added filter aj_wcwl_can_user_add_to_wishlist
* Dev: added filters aj_wcwl_add_wishlist_{property}
* Dev: added filters aj_wcwl_adding_to_wishlist_{property}
...
* Dev: added new aj_wcwl_product_already_in_wishlist_text_button and aj_wcwl_product_added_to_wishlist_message_button filters
* Dev: added new aj_wcwl_out_of_stock_label and aj_wcwl_in_stock_label filters
...
* Dev: add filter aj_wcwl_wishlist_correctly_created on add_wishlist function
...
* Dev: new filter aj_wcwl_wishlist_disabled_for_unauthenticated_user_message_condition
* Dev: New action 'aj_wcwl_default_user_wishlist'

= 2.2.9 - Released on 11 April 2019 =

* New: WooCommerce 3.6.x support
* New: added a WhatsApp share button on mobile
* New: add new shortcode aj_wcwl_show_public_wishlist
...
* Dev: add filter aj_wcwl_email_share_subject
...
* Dev: added product param to aj_free_text filter
* Dev: added aj_wcwl_login_register_redirect filter to let third party code filter redirect uri for unauthenticated users
...
* Update: Spanish language
* Update: Italian language
* Dev: added new filter aj_wcwl_localize_script to let third party dev filter localization variables
* Dev: added new filter aj_wcwl_column_default
* Dev: added new filter aj_wcwl_wishlist_column
* Dev: added new filter aj_wcwl_share_conditions to display the share buttons for no logged users
* Dev: added new filter aj_wcwl_set_cookie to let third party code skip cookie saving
* Dev: added new filter aj_wcwl_wishlist_visibility_string_value to the wishlist visibility value
* Dev: added new filter aj_wcwl_manage_wishlist_title
* Dev: added new filter aj_wcwl_create_wishlist_title
* Dev: added new filter aj_wcwl_search_wishlist_title
* Dev: added new filter aj_wcwl_result_wishlist
* Dev: added new filter aj_wcwl_empty_search_result
* Dev: added new filter aj_wcwl_wishlist_param to change query-string param
* Dev: added new filter aj_wcwl_remove_product_wishlist_message_title
...
* Update: Italian language
* Dev: added filter aj_wcwl_redirect_url
* Dev: added filter aj_wcwl_login_notice
...
* Dev: added filter aj_wcwl_estimate_additional_data to let developers add custom data to print in Estimate Email template
* Dev: added aj_wcwl_removing_from_wishlist / aj_wcwl_removed_from_wishlist hooks
...
* Dev: added aj_wcwl_admin_table_show_empty_list filter to show empty lists on admin
...
* New: added action_params param to aj_wcwl_wishlist shortcode, to let administrators show different wishlist views on different pages
...
* Fix: global aj_wcwl_wishlist_token (false for default wishlists)
...
* Dev: added filter aj_wcwl_create_new_wishlist_title on wishlist-manage.php
* Dev: added filter aj_wcwl_ask_an_estimate_text
* Dev: action as second param for aj_wcwl_wishlist_page_url filter
* Dev: applied filter aj_wcwl_no_product_to_remove_message also for message on wishlist-view template
* Dev: added filter aj_wcwl_add_wishlist_user_id
* Dev: added filter aj_wcwl_add_wishlist_slug
* Dev: added filter aj_wcwl_add_wishlist_name
* Dev: added filter aj_wcwl_add_wishlist_privacy
* Dev: added aj_wcwl_promotional_email_thumbnail_size filter
* Dev: added filters aj_wcwl_estimate_sent & aj_wcwl_estimate_missing_email
...
* Added: filter aj_wcwl_is_product_in_wishlist to choose whether a product is in wishlist or not
* Added: filter aj_wcwl_cookie_expiration to set default wishlist cookie expiration time in seconds
* Tweak: updated plugin-fw
...
Added: aj_wcwl_is_wishlist_page function to identify if current page is wishlist page
Added: filter aj_wcwl_settings_panel_capability for panel capability
Added: filter aj_wcwl_current_wishlist_view_params for shortcode view params
Added: "defined AJ_WCWL" check before every template
Added: check over existance of $.prettyPhoto.close before using it
Added: method count_add_to_wishlist to AJ_WCWL class
Added: function aj_wcwl_count_add_to_wishlist
Tweak: Changed ajax url to "relative"
Tweak: Removed dido-common (old plugin-fw) deprecated since 2.0
...
Fixed: typo in hook aj_wccl_table_after_product_name (now set to aj_wcwl_table_after_product_name)
...
* Added compatibility with AJ WooCommerce Email Templates
* Added 'aj_wcwl_added_to_cart_message' filter, to customize added to cart message in wishlist page
* Added 'aj_wcwl_action_links' filter, to customize action link at the end of wishlist pages
* Added nofollow to "Add to Wishlist" links, where missing
* Added 'aj_wcwl_email_share_subject' filter to customize share by email subject
* Added 'aj_wcwl_email_share_body' filter to customize share by email body
* Added function "aj_wcwl_count_all_products"
* Fixed plugin-fw loading

= 2.0.12 - Released on 23 October 2015 =

* Added: method to count all products in wishlist
* Tweak: Added wishlist js handling on 'aj_wcwl_init' triggered on document
...
* Updated: changed text domain from dido to aj-woocommerce-wishlist
...
* Tweak: added aj_wcwl_custom_add_to_cart_text and aj_wcwl_ask_an_estimate_text filters
...
* Fixed: icon attribute for aj_wcwl_add_to_wishlist shortcode
...
* Tweak: moved WC notices from wishlist template to aj_wcwl_before_wishlist_title hook
* Tweak: added wishlist table id to .load(), to update only that part of template
* Fixed: aj_wcwl_locate_template causing 500 Internal Server Error
