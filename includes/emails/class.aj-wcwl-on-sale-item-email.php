...
if ( ! class_exists( 'AJ_WCWL_On_Sale_Item_Email' ) ) {
	/**
	 * On sale item email
	 *
	 * @since 1.0.0
	 */
	class AJ_WCWL_On_Sale_Item_Email extends WC_Email {
		...
		public function __construct() {
			$this->id          = 'aj_wcwl_on_sale_item';
			$this->title       = __( 'Wishlist "On sale item" email', 'aj-woocommerce-wishlist' );
			$this->description = __( 'This email is sent to customers when an item of their wishlist is on sale', 'aj-woocommerce-wishlist' );

			$this->heading = __( 'An item of your wishlist is on sale!', 'aj-woocommerce-wishlist' );
			$this->subject = __( 'An item of your wishlist is on sale!', 'aj-woocommerce-wishlist' );
		...
		public function init_form_fields() {
			...
			$this->form_fields = array(
				...
				'product_exclusions' => array(
					...
					'type'        => 'multiselect',
					'description' => __( 'Select products for which you don\'t want to send a reminder email', 'aj-woocommerce-wishlist' ),
				...
				'category_exclusions' => array(
					...
					'description' => __( 'Select product categories for which you don\'t want to send a reminder email', 'aj-woocommerce-wishlist' ),
...
return new AJ_WCWL_On_Sale_Item_Email();
