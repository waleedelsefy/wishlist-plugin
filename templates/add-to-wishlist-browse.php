...
<div class="aj-wcwl-wishlistexistsbrowse" data-product-id="<?php echo esc_attr( $product_id ); ?>" data-original-product-id="<?php echo esc_attr( $parent_product_id ); ?>">
	<span class="feedback">
	...
	<a href="<?php echo esc_url( $wishlist_url ); ?>" rel="nofollow" data-title="<?php echo esc_attr( $browse_wishlist_text ); ?>">
		...
		<?php echo wp_kses_post( apply_filters( 'aj-wcwl-browse-wishlist-label', $browse_wishlist_text, $product_id, $icon ) ); ?>
	</a>
</div>
