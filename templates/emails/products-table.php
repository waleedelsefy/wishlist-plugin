 ...
 * @var $items         AJ_WCWL_Wishlist_Item[]
 */
...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin: 0 0 16px;" border="1">
	<thead>
	<tr>
		<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Product', 'aj-woocommerce-wishlist' ); ?></th>
		<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Price', 'aj-woocommerce-wishlist' ); ?></th>
	...
	<?php foreach ( $items as $item ) : ?>
		...
		<tr class="<?php echo esc_attr( apply_filters( 'aj_wcwl_wishlist_item_class', 'wishlist_item', $item ) ); ?>">
