...
<div class="aj-wcwl-add-button with-dropdown">
	<a href="<?php echo AJ_WCWL()->get_add_to_wishlist_url( $product_id, array( 'base_url' => $base_url ) ); ?>" rel="nofollow" data-product-id="<?php echo esc_attr( $product_id ); ?>" data-product-type="<?php echo esc_attr( $product_type ); ?>" data-original-product-id="<?php echo esc_attr( $parent_product_id ); ?>" class="<?php echo esc_attr( $link_classes ); ?>" data-title="<?php echo esc_attr( apply_filters( 'aj_wcwl_add_to_wishlist_title', $label ) ); ?>">
	...
	<?php if( ! empty( $lists ) ): ?>
		...
		<!-- WISHLIST DROPDOWN -->
		<ul id="add_to_wishlist_popup_<?php echo esc_attr( $product_id ); ?>_<?php echo esc_attr( $unique_id ); ?>" class="aj-wcwl-dropdown">
