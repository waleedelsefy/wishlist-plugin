						...
						<table class="item-details-table">
							<?php if ( $show_number_of_items ) : ?>
								<tr class="wishlist-item-count">
									<td class="label"><?php esc_html_e( 'Items:', 'aj-woocommerce-wishlist' ); ?></td>
									<td class="value">
										<?php
							...
							<tr class="wishlist-privacy">
								<td class="label"><?php esc_html_e( 'Visibility:', 'aj-woocommerce-wishlist' ); ?></td>
								<td class="value">
							...
							<?php if ( $show_date_of_creation ): ?>
								<tr class="wishlist-dateadded">
									<td class="label"><?php esc_html_e( 'Created on:', 'aj-woocommerce-wishlist' ); ?></td>
								...
								<tr>
									<td class="value" colspan="2">
										...
										<?php if ( $show_delete_wishlist ): ?>
											<a class="wishlist-delete" onclick="return confirm('<?php esc_html_e( 'Are you sure you want to delete this wishlist?', 'aj-woocommerce-wishlist' ); ?>');" href="<?php echo esc_url( $wishlist->get_delete_url() ); ?>"><i class="fa fa-trash"></i></a>
										<?php endif; ?>
									</td>
								</tr>
							<?php endif; ?>
					...
					<div class="product-thumbnail">
						...
						if ( $wishlist->has_items() ) :
							...
							<div class="placeholder-item empty-box">
								<p><?php echo wp_kses_post( apply_filters('aj_wcwl_modern_wishlist_empty_message', __( 'This wishlist is empty.<br/>Add some item soon!', 'aj-woocommerce-wishlist' ) ) ); ?></p>
							</div>
							<?php
						endif;
						?>
