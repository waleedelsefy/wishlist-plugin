	...
	if ( $wishlist && $wishlist->has_items() ) :
		foreach ( $wishlist_items as $item ) :
			...
			if ( $product && $product->exists() ) :
				?>
				<li id="aj-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
							...
							<div class="item-details-wrapper">
									...
									<table class="item-details-table">
										...
										<?php if ( $show_price || $show_price_variations ) : ?>
											<tr class="product-price">
												<td class="label">
													<?php esc_html_e( 'Unit Price:', 'aj-woocommerce-wishlist' ); ?>
												</td>
												<td class="value">
													<?php
													if ( $show_price ) {
								...
								<?php if ( $show_remove_product ) : ?>
									<div class="product-remove">
										<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>" class="remove_from_wishlist" title="<?php echo esc_attr( apply_filters( 'aj_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'aj-woocommerce-wishlist' ) ) ); ?>"><i class="fa fa-trash"></i></a>
									</div>
								<?php endif; ?>
