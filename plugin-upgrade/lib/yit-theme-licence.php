...
if ( ! class_exists( 'AJ_Theme_Licence' ) ) {
	/**
	 * DIDO Plugin Licence Panel
	 * Setting Page to Manage Plugins
	 *
	 * @class      AJ_Theme_Licence
	 * @since      1.0
	 * @author     Andrea Grillo      <andrea.grillo@ajemes.com>
	 * @package    AJ
	 */
	class AJ_Theme_Licence extends AJ_Licence {
		 ...
		 * @var string
		 */
		protected $licence_option = 'dido_theme_licence_activation';
		...
		public function __construct() {
			...
			$this->settings = array(
				'parent_page' => 'dido_product_panel',
		...
		public function add_submenu_page() {
			...
			$admin_tree = array(
				'parent_slug' => apply_filters( 'dido_licence_parent_slug', 'dido_panel' ),
				'page_title'  => __( 'License Activation', 'aj-plugin-upgrade-fw' ),
				'menu_title'  => __( 'License Activation', 'aj-plugin-upgrade-fw' ),
				'capability'  => 'manage_options',
				'menu_slug'   => 'dido_panel_license',
		...
		public function get_old_licence_message() {
			...
			<div class="activation-faq">
				<h3><?php esc_html_e( 'I cannot find the license key for activating the theme I have bought some time ago. Where can I find it?', 'aj-plugin-upgrade-fw' ); ?></h3>
				...
				<p>
                    ...
                    provided with and that you can find in your AJ account, in section "My licenses".',
						'aj-plugin-upgrade-fw'
					);
					?>
				</p>
			</div>
		...
		public function get_license_url() {
			return add_query_arg( array( 'page' => 'dido_panel_license' ), admin_url( 'admin.php' ) );
		}
	}
}
...
if ( ! function_exists( 'AJ_Theme_Licence' ) ) {
	 ...
	 * @since  1.0
	 * @author Francesco Licandro
	 * @return AJ_Theme_Licence
	 */
	function AJ_Theme_Licence() { // phpcs:ignore
		return AJ_Theme_Licence::instance();
	}
}
